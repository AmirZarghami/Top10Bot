...
software_version_GC = 1.02 #as you update this value keep in mind to update prog to prof compatability dict in the DictsListsStuff Module
MAX_AWARD_COUNT = 20
...
stats_similarity_theshold = 0.77
